...
# Debian/Ubuntu Postgres trusts the local socket, not TCP: point node-pg (tsx E2Es) at the socket too.
[ -z "${PGHOST:-}" ] && [ -S /var/run/postgresql/.s.PGSQL.5432 ] && export PGHOST=/var/run/postgresql
