...
- Guardrails: unsubscribe rate, SMS opt-out rate, spam complaints, bounce rate

## Copy rules specific to this product
- (legal/brand constraints that every message must obey — pulled from CLAUDE.md/AGENTS.md if any)
""")
PY
